    ...
    return (
      <ScrollView style={{ flex: 1 }}>
        <View style={styles.mainView}>
          ...
          <View>
            <TextInput placeholder={"Phone"} style={styles.textInputStyle} 
          ...
          <View>
            <TextInput placeholder={"Designation"} style={styles.textInputStyle} 
            value = {this.state.Designation}
            onChangeText={(text) => this.setState({ Designation: text })}  ></TextInput>
          </View>
          <View>
            <TextInput placeholder={"Profile"} style={styles.textInputStyle}></TextInput>
          </View>
          <View>
            <TextInput placeholder={"Address"} style={styles.textInputStyle}></TextInput>
          </View>
